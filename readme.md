...
故出现文字之后暂停dump，搜索font文件二进制代码+0x2000000定位，ida逆向分析，详略。
...
可修改哈夫曼解码使之不再跳过00，并获取中文编码后压入，亦可直接覆盖原哈夫曼加密字串，直接b指令跳过解密读取编码

字库见 [Animus_18b.font](Animus_18b.font) ，可使用tinke压入中文
